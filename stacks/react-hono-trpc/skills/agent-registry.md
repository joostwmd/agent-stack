---
name: agent-registry
description: Single source of truth for all agents in this stack — layer ownership, output artifacts, and assignment rules
---
...
- **Layer:** API / Backend
- **Responsible for:** Creating and modifying Hono routes, tRPC procedures, and data-fetching functions
- **Output artifact:** Route or procedure file (e.g. `src/server/routers/<name>.ts`)
- **Commit prefix:** api:

### auth-agent

- **Layer:** Auth
- **Responsible for:** Protecting routes and endpoints with Better Auth guards. Auth is enforced at the application layer, not via RLS.
- **Output artifact:** Guard function, middleware, or protected route wrapper
- **Commit prefix:** auth:
...
- **Output artifact:** Component or page file (e.g. `src/pages/<page>.tsx`, `src/components/<name>.tsx`)
- **Commit prefix:** ui:
